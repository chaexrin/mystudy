...
public class AssignmentMenu {
  ...
  static Assignment[] assignments = new Assignment[3]; // 레퍼런스 배열
  static int length = 0;
  ...
  static void add() {
    ...
    if (length == assignments.length) {
      // System.out.println("과제를 더이상 등록할 수 없습니다."); 배열 늘림
    ...
    assignment.title = Prompt.input("과제명? "); // assignment 레퍼런스가 가르키는 인스턴스
