...
public class DispatcherServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Object[] args = prepareRequestHandlerArguments(requestHandler.handler, request,
                response);

            String viewUrl = (String) requestHandler.handler.invoke(requestHandler.controller,
                args);
        ...
        for (Object controller : controllers) {
            ...
            for (Method m : methods) {
                ...
                if (requestMapping != null) {
                    requestHandlerMap.put(requestMapping.value(),
    ...
    // request handler의 파라미터 타입이 도메인 클래스 일 때
    ...
    private Object createValueObject(Class<?> type, HttpServletRequest request) throws Exception {
        ...
        for (Method setter : methods) {
            ...
            String propName =
                Character.toLowerCase(setter.getName().charAt(3)) + setter.getName()
                    .substring(4);
            ...
            if (requestParamValue != null) {
                Class<?> setterParameterType = setter.getParameters()[0].getType(); // 셋터 메서드의 파리미터 타입을 알아낸다.
