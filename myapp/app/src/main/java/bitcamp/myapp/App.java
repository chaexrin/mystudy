...
public class App {
  ...
  public static void main(String[] args) throws Exception {
    ...
    ObjectRepository greetingboardRepository = new ObjectRepository();
    ...
    //BoardModifyHandler boardModifyHandler = new BoardModifyHandler(boardRepository, prompt);
    //MenuItem menuItem = new MenuItem("변경", boardModifyHandler);
    ...
    MenuGroup greetingMenu = new MenuGroup("가입 인사");
    greetingMenu.add(new MenuItem("등록", new BoardAddHandler(greetingboardRepository, prompt)));
    greetingMenu.add(new MenuItem("조회", new BoardViewHandler(greetingboardRepository, prompt)));
    greetingMenu.add(new MenuItem("변경", new BoardModifyHandler(greetingboardRepository, prompt)));
    greetingMenu.add(new MenuItem("삭제", new BoardDeleteHandler(greetingboardRepository, prompt)));
    greetingMenu.add(new MenuItem("목록", new BoardListHandler(greetingboardRepository)));
